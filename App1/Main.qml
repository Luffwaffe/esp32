...
Window {
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            width: 100
            height: 50
            color:  roomInforRec.timeChoice == 30? "green" :"#D4DFE3"
            anchors.top:startEndBtn.top
            anchors.left: parent.left
            ...
            MouseArea{
                ...
                onClicked: {
                    if(roomInforRec.roomModel.runningStatus !== "started"){
                        roomInforRec.roomModel.setTimeBtnClick(0030);
                        roomInforRec.timeChoice = 30
                    }
                }
            }
        }
        ...
        Rectangle {
            ...
            width: 100
            height: 50
            color:  roomInforRec.timeChoice == 1? "green" :"#D4DFE3"
            anchors.top:startEndBtn.top
            anchors.left: btn30m.right
            anchors.leftMargin: 20
            radius:15
            ...
            MouseArea{
                ...
                onClicked: {
                    if(roomInforRec.roomModel.runningStatus !== "started"){
                        roomInforRec.roomModel.setTimeBtnClick(0100);
                        roomInforRec.timeChoice = 1
                    }
                }
            }
        ...
        Rectangle {
            ...
            width: 100
            height: 50
            color:  roomInforRec.timeChoice == 15? "green" :"#D4DFE3"
            anchors.top:startEndBtn.top
            anchors.left: btn1h.right
            anchors.leftMargin: 20
            radius:15
            ...
            MouseArea{
                ...
                onClicked: {
                    if(roomInforRec.roomModel.runningStatus !== "started"){
                        roomInforRec.roomModel.setTimeBtnClick(0130);
                        roomInforRec.timeChoice = 15
                    }
                }
            }
        }
        ...
        Rectangle {
            ...
            width: 100
            height: 50
            color:  roomInforRec.timeChoice == 2? "green" :"#D4DFE3"
            anchors.bottom:startEndBtn.bottom
            anchors.left: parent.left
            anchors.leftMargin: 20
            radius:15
            ...
            MouseArea{
                ...
                onClicked: {
                    if(roomInforRec.roomModel.runningStatus !== "started"){
                        roomInforRec.roomModel.setTimeBtnClick(0200);
                        roomInforRec.timeChoice = 2
                    }
                }
            }
        }
        ...
        Rectangle {
            ...
            width: 100
            height: 50
            color:  roomInforRec.timeChoice == 25? "green" :"#D4DFE3"
            anchors.bottom:startEndBtn.bottom
            anchors.left: btn2h.right
            anchors.leftMargin: 20
            radius:15
            ...
            MouseArea{
                ...
                onClicked: {
                    if(roomInforRec.roomModel.runningStatus !== "started"){
                        roomInforRec.roomModel.setTimeBtnClick(0230);
                        roomInforRec.timeChoice = 25
                    }
                }
            }
        }
        ...
        Rectangle {
            ...
            width: 100
            height: 50
            color:  roomInforRec.timeChoice == 0? "green" :"#D4DFE3"
            anchors.bottom:startEndBtn.bottom
            anchors.left: btn2_5h.right
            anchors.leftMargin: 20
            radius:15
        ...
        Loader {
            ...
            Rectangle {
                ...
                Text {
                    id: timeRemain
                    text: (roomInforRec.roomModel && roomInforRec.roomModel.runningStatus === "started")?
                              "Time remaining: " + roomInforRec.roomModel.timeRemainning: "Time remaining: 00:00:00"
                    font.pixelSize: 25
                    font.bold: true
                    color:  !roomInforRec.roomModel ? "grey" :
                            roomInforRec.roomModel.runningStatus === "started" ? "green" :
